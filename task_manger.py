...
# Function to Updae a task.
def update_task():
    view_task() # DRY principle
    if tasks: #It checks if there are tasks first before updating.
        task_num = int(input("Your task number you want to edit: ")) - 1 # -1 to convert to 0 based index
